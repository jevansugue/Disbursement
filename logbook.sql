...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2014 at 02:58 PM
...
CREATE TABLE IF NOT EXISTS `disbursement_tbl` (
  ...
  `n_amt` float DEFAULT NULL,
  `mop` enum('CTA','MC') DEFAULT NULL,
  ...
  `status` enum('RETURNED','FOR PROCESSING','FOR REVIEW') DEFAULT NULL,
  PRIMARY KEY (`dv_id`)
